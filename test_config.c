...
static void
test_single_device_legacy (void)
{
...
static void
test_mixed_device_and_device2 (void)
{
...
static void
test_no_device_autodetect (void)
{
...
static void
test_single_values_parsed (void)
{
...
static void
test_comments_and_empty_lines (void)
{
...
static void
test_device_out_of_range_ignored (void)
{
...
static void
test_connector_and_gamma_size (void)
{
...
static void
test_gamma_size_out_of_range_reset (void)
{
...
static void
test_connector_default_empty (void)
{
...
static void
test_validation_clamps_temp (void)
{
  ...
  ASSERT (config.day_temp == 6500, "day_temp uses default (99999 rejected)");
  ASSERT (config.night_temp == 3500, "night_temp uses default (1 rejected)");
}
